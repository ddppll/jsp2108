...
<div class="container">
	...
	<table class="table">
		...
		<tr>
			<td>탈퇴여부 : 
				<c:if test="${vo.userDel eq 'OK'}"><font color="red">탈퇴신청</font></c:if>
				<c:if test="${vo.userDel ne 'OK'}">활동중</c:if>
			</td>
		</tr>
	...
	<hr/>
<a href ="${ctp}/adMemberList.ad" class="btn btn-secondary btn-sm">돌아가기</a>
</div>
<br/>
</body>
</html>
...
insert into member values(default, 'admin','1234',1,'관리맨','관리자',default,default,'010-1234-5678','서울시 마포구','abcd1234@naver.com','blog.daum.net/abcd1234','프리랜서','등산/바둑',default,'관리자입니다',default,default,default,default,default,default,default);